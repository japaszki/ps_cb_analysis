...
pf.set_figsize((12,9))
pf.plot([1, 2], edge_vs_acq_corr, '-s', label='Edge method')
pf.plot(fs_harms, filt_vs_acq_corr, '-s', label='Filter method')
pf.plot(fs_harms, ps_vs_acq_corr, '-s', label='Phase space method')
pf.xlabel('fs harmonic')
pf.ylabel('Pearson correlation coefficient of tomoscope vs. internal acq data')
pf.ylim([0,1])
pf.legend(loc=0, fontsize='medium')
pf.set_filename(output_dir + '/tomo_acq_correlation_vs_fs_harm')
pf.set_fontsize(20)
pf.gen_plot()
pf.save_yaml()
...
pf = pfig.portable_fig()
pf.set_figsize((12,9))
pf.plot([1, 2], edge_vs_acq_slope_error, '-s', label='Edge method')
pf.plot(fs_harms, filt_vs_acq_slope_error, '-s', label='Filter method')
pf.plot(fs_harms, ps_vs_acq_slope_error, '-s', label='Phase space method')
pf.xlabel('fs harmonic')
pf.ylabel('Slope / uncertainty of tomoscope vs. internal acq data')
pf.ylim(bottom=0)
pf.legend(loc=0, fontsize='medium')
pf.set_filename(output_dir + '/tomo_acq_slope_error_vs_fs_harm')
pf.set_fontsize(20)
pf.gen_plot()
pf.save_yaml()
...
# pf = pfig.portable_fig()
# pf.set_figsize((12,9))
# pf.plot(fs_harms, filt_median, '-s', label='Filter method')
# pf.xlabel('fs harmonic')
# pf.ylabel('Median value')
# pf.legend(loc=0, fontsize='medium')
# pf.set_fontsize(20)
# pf.gen_plot()
...
# pf = pfig.portable_fig()
# pf.set_figsize((12,9))
# pf.plot(fs_harms, ps_median, '-s', label='Phase space method')
# pf.xlabel('fs harmonic')
# pf.ylabel('Median value')
# pf.legend(loc=0, fontsize='medium')
# pf.set_fontsize(20)
...
# pf = pfig.portable_fig()
# pf.set_figsize((12,9))
# pf.plot(fs_harms, acq_median, '-s', label='Internal acquisition')
# pf.xlabel('fs harmonic')
# pf.ylabel('Median value')
# pf.legend(loc=0, fontsize='medium')
# pf.set_fontsize(20)
...
pf = pfig.portable_fig()
pf.set_figsize((12,9))
pf.plot(fs_harms, ps_harm_vs_h1_corr, '-s',  label='Phase space') #,
pf.plot(fs_harms, acq_harm_vs_h1_cov, '-s',  label='Internal acq')
pf.xlabel('N')
pf.ylabel('Pearson correlation coefficient of N*fs vs. 1*fs')
pf.ylim([0,1])
pf.legend(loc=0, fontsize='medium')
pf.set_filename(output_dir + '/correlation_1fs_vs_fs_harm')
pf.set_fontsize(20)
pf.gen_plot()
pf.save_yaml()
...
pf = pfig.portable_fig()
pf.set_figsize((12,9))
pf.plot(fs_harms, ps_harm_vs_h2_corr, '-s', label='Phase space')
pf.plot(fs_harms, acq_harm_vs_h2_cov, '-s', label='Internal acq')
pf.xlabel('N')
pf.ylabel('Pearson correlation coefficient of N*fs vs. 2*fs')
pf.ylim([0,1])
pf.legend(loc=0, fontsize='medium')
pf.set_filename(output_dir + '/correlation_2fs_vs_fs_harm')
pf.set_fontsize(20)
pf.gen_plot()
pf.save_yaml()